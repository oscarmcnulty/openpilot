...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"DmModelInitialized", CLEAR_ON_IGNITION_ON},
    {"DongleId", PERSISTENT},
    ...
    {"LastOffroadStatusPacket", CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_OFF},
    ...
    {"Offroad_Recalibration", CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_ON},
    ...
    {"PandaSomResetTriggered", CLEAR_ON_MANAGER_START | CLEAR_ON_IGNITION_OFF},

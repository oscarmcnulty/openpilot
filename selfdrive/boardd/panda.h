// hard-forked from https://github.com/commaai/openpilot/tree/05b37552f3a38f914af41f44ccc7c633ad152a15/selfdrive/boardd/panda.h
#pragma once
...
class Panda {
 ...
 public:
  Panda(const int fd, uint32_t bus_offset=0);
